        ...
        if ($_POST['action'] == 'reset_password') {
            ...
            try {
                ...
                if ($stmt->rowCount() > 0) {
                    ...
                    if (function_exists('logActivity')) {
                        logActivity($_SESSION['user_id'], 'RESET_ADMIN_PASSWORD', "Reset password for admin: $username");
                    }
                        ...
                        <td>
                            <?php if ($admin['id'] != $_SESSION['user_id']): ?>
                                <form method="POST" style="display: inline;">
                                    ...
                                    <button type="submit" class="btn-icon btn-reset" title="Reset Password" onclick="return confirm('Reset password for <?php echo htmlspecialchars($admin['username']); ?>?')">
                            ...
                            <?php else: ?>
                                <span style="color: var(--muted);"><i class="fas fa-lock"></i></span>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <?php endforeach; ?>
